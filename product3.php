<?php
    setcookie('product3', isset($_COOKIE['product3']) ? ++$_COOKIE['product3'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Manchester United Jersey",time()+60*60*30*24,"/");

    setcookie('shaproduct3', isset($_COOKIE['shaproduct3']) ? ++$_COOKIE['shaproduct3'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
        $x=$_COOKIE['number'];
        $x++;
        if($x>5) $x=1;
...
<html>
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 003 </h3>
                    <h3> Product Name: Manchester United Jersey </h3>
                    <h3> Product Brand: Adidas </h3>
                    <h3> Price: $35 </h3>
                    <h3> Product Type: Jersey </h3>
										</section>


										<form method="post" action="add_to_cart.php">
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productName" value="Manchester United Jersey" style="width: 500px;">
                                        </div>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productPrice" value="35" style="width: 500px;">
                                        </div>
 ...
 <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false" class="fa fa-twitter" >Tweet</a>
    ...
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product3.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
...
$dbname = "CMP272";
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha3'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewSha3.php" style="margin-left: 20px;">
                  <div class="form-group">
