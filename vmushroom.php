<?php
    ...
    setcookie('vinproduct5', isset($_COOKIE['vinproduct5']) ? ++$_COOKIE['vinproduct5'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Mushroom",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vmushroom.php'">Share With Google+</button>
</div>
...
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="mushroom" style="width: 500px;">
</div>
<div class="form-group">
  <input type="text" class="form-control" name="productPrice" value="40" style="width: 500px;">
</div>
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin7'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin7.php" style="margin-left: 20px;">
                  <div class="form-group">
