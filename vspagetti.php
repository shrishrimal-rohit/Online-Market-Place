<?php
    ...
    setcookie('vinproduct7', isset($_COOKIE['vinproduct7']) ? ++$_COOKIE['vinproduct7'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"spagetti",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vspagetti.php'">Share With Google+</button>
</div>
...
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="spaghetti" style="width: 500px;">
</div>
<div class="form-group">
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin9'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin6.php" style="margin-left: 20px;">
                  <div class="form-group">
