<?php
    setcookie('product5', isset($_COOKIE['product5']) ? ++$_COOKIE['product5'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"BaseBall Bat",time()+60*60*30*24,"/");

    setcookie('shaproduct5', isset($_COOKIE['shaproduct5']) ? ++$_COOKIE['shaproduct5'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 005 </h3>
                    <h3> Product Name: BaseBall Bat  </h3>
                    ...
                    <h3> Price: $160 </h3>
                                        ...
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productName" value="BaseBall bat" style="width: 500px;">
                                        </div>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productPrice" value="160" style="width: 500px;">
                                        </div>
...
<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false" class="fa fa-twitter" >Tweet</a>
    ...
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product5.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha5'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewSha5.php" style="margin-left: 20px;">
                  <div class="form-group">
