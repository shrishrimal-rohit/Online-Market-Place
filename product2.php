<?php
    setcookie('product2', isset($_COOKIE['product2']) ? ++$_COOKIE['product2'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"HRX Shoes",time()+60*60*30*24,"/");

    setcookie('shaproduct2', isset($_COOKIE['shaproduct2']) ? ++$_COOKIE['shaproduct2'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 002 </h3>
                    <h3> Product Name: HRX shoes </h3>
                    <h3> Product Brand: HRX </h3>
                    <h3> Price: $50 </h3>
                    <h3> Product Type: Shoes </h3>
										</section>
										<form method="post" action="add_to_cart.php">
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productName" value="HRX shoes" style="width: 500px;">
                                        </div>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productPrice" value="50" style="width: 500px;">
                                        </div>
...
<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false" class="fa fa-twitter" >Tweet</a>
    ...
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product2.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
								</div>
							</div>
						</div>
					</div>
...
$dbname = "CMP272";
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha2'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewSha2.php" style="margin-left: 20px;">
                  <div class="form-group">
