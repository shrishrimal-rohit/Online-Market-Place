<?php
    ...
    setcookie('vinproduct1', isset($_COOKIE['vinproduct1']) ? ++$_COOKIE['vinproduct1'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"BreakFast",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://www.singhvinit.com/breakfast.php'">Share With Google+</button>
</div>
...
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="BreakFast" style="width: 500px;">
</div>
<div class="form-group">
  <input type="text" class="form-control" name="productPrice" value="90" style="width: 500px;">
</div>
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin4'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin4.php" style="margin-left: 20px;">
                  <div class="form-group">
