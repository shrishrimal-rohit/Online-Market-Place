<?php
    setcookie('dinner', isset($_COOKIE['dinner']) ? ++$_COOKIE['dinner'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"Dinner",time()+60*60,"/");

    setcookie('vinproduct10', isset($_COOKIE['vinproduct10']) ? ++$_COOKIE['vinproduct10'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Dinner",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vdinner.php'">Share With Google+</button>
</div>

<figure>
  <img src="images/gallery-img6.jpg" alt="Food Menu" width="400
  " height="400">

</figure>
<p><strong>Description:</strong>Dinner</p>

<!-- paste this in other pages -->

<form method="post" action="add_to_cart.php">
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="dinner" style="width: 500px;">
</div>
<div class="form-group">
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin5'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin5.php" style="margin-left: 20px;">
                  <div class="form-group">
