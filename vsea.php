<?php
    setcookie('sea', isset($_COOKIE['sea']) ? ++$_COOKIE['sea'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"sea",time()+60*60,"/");

    setcookie('vinproduct2', isset($_COOKIE['vinproduct2']) ? ++$_COOKIE['vinproduct2'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Sea",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vsea.php'">Share With Google+</button>
</div>


<figure>
  <img src="images/gallery-img4.jpg" alt="Food Menu" width="400
  " height="400">

</figure>
<p><strong>Description:</strong>Sea</p>

<!-- paste this in other pages -->

<form method="post" action="add_to_cart.php">
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="sea" style="width: 500px;">
</div>
<div class="form-group">
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin8'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin8.php" style="margin-left: 20px;">
                  <div class="form-group">
