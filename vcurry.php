<?php
    ...
    setcookie('vinproduct6', isset($_COOKIE['vinproduct6']) ? ++$_COOKIE['vinproduct6'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Curry",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vcurry.php'">Share With Google+</button>
</div>
...
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="Curry" style="width: 500px;">
</div>
<div class="form-group">
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin6'");
