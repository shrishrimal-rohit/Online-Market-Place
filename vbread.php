<?php
    ...
    setcookie('vinproduct9', isset($_COOKIE['vinproduct9']) ? ++$_COOKIE['vinproduct9'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Bread",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vbread.php'">Share With Google+</button>
    <img src="images1/glogin.png" alt=""/>
</div>
...
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="bread" style="width: 500px;">
</div>
<div class="form-group">
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin3'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin3.php" style="margin-left: 20px;">
                  <div class="form-group">
