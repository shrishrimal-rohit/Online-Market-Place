<?php
    setcookie('p4', isset($_COOKIE['p4']) ? ++$_COOKIE['p4'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"CORE JAVA",time()+60*60*24*30,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/rp4.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
