<?php
    setcookie('new', isset($_COOKIE['new']) ? ++$_COOKIE['new'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"New Cars",time()+60*60,"/");

    setcookie('shanproduct3', isset($_COOKIE['shanproduct3']) ? ++$_COOKIE['shanproduct3'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"New Cars",time()+60*60*30*24,"/");
...
<div class="allcontain">
			...
			<div class="col-lg-12 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="image/car6.jpg" alt="porsche">
					</div>
    ...
    <div class="form-group">
      <input type="text" class="form-control" name="productName" value="New Cars" style="width: 500px;">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" name="productPrice" value="850" style="width: 500px;">
    </div>
...
<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false" class="fa fa-twitter" >Tweet</a>
    ...
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/news.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
	<?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='shan6'");
    ...
    <hr/>
                <h3 style="text-decoration: underline;"> Leave a Review..</h3>
                  <form method="POST" action="processReviewShan6.php" style="margin-left: 20px;">
                      <div class="form-group">
