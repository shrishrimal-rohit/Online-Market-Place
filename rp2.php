<?php
    setcookie('p2', isset($_COOKIE['p2']) ? ++$_COOKIE['p2'] : 1,time()+60*60,"/");
    ...
    setcookie($x,"LET US C",time()+60*60*24*30,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/rp2.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
