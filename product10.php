<?php
    setcookie('product10', isset($_COOKIE['product10']) ? ++$_COOKIE['product10'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Dumbell 20kg",time()+60*60*30*24,"/");

    setcookie('shaproduct10', isset($_COOKIE['shaproduct10']) ? ++$_COOKIE['shaproduct10'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 010 </h3>
                    <h3> Product Name: Dumbell 20kg </h3>
                    <h3> Product Brand: TrainFit </h3>
                    <h3> Price: $120 </h3>

										</section>
										<form method="post" action="add_to_cart.php">
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productName" value="Dumbell 20kg" style="width: 500px;">
                                        </div>
                                        <div class="form-group">
...
$dbname = "CMP272";
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha10'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewSha10.php" style="margin-left: 20px;">
                  <div class="form-group">
