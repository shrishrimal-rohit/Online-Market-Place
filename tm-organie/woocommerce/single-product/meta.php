...
<div class="product_meta_wrap">
	<table class="product_meta">
		...
		<?php echo wp_kses( wc_get_product_category_list( $product_id, ', ', '<tr class="product_meta_item posted_in"><td class="label">' . _n( 'Category', 'Categories', $cat_count, 'tm-organie' ) . '</td><td> ', '</td></tr>' ), array(
			'tr' => array(
				'class' => array(),
			),
			'td' => array(
		...
		<?php echo wp_kses( wc_get_product_tag_list( $product_id, ', ', '<tr class="product_meta_item tagged_as"><td class="label">' . _n( 'Tag', 'Tags', $tag_count, 'tm-organie' ) . '</td><td> ', '</td></tr>' ), array(
			'tr' => array(
				'class' => array(),
			),
			'td' => array(
