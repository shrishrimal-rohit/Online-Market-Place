...
Kiki::add_field( 'theme', array(
	...
	'settings'    => 'shop_archive_category_columns',
	'label'       => esc_html__( 'Category Columns', 'tm-organie' ),
	'description' => esc_html__( 'Controls the columns of category (or sub-category) on shop or product category page.', 'tm-organie' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'default'     => '4',
	'choices'     => array(
