		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="footer-text">
					<?php
					esc_html_e('We are Online Market of organic fruits, vegetables, juices and dried fruits. Visit our site for a complete list of exclusive we are stocking.', 'tm-organie');
					?>
				</div>
			</div>
			<div class="col-md-12">
