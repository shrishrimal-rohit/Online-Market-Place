...
require_once( INSIGHT_THEME_DIR . '/framework/class-compatible.php' );
require_once( INSIGHT_THEME_DIR . '/framework/class-customize.php' );
require_once( INSIGHT_THEME_DIR . '/framework/class-detect.php' );
...
require_once( INSIGHT_THEME_DIR . '/framework/class-security.php' );
...
require_once( INSIGHT_THEME_DIR . '/framework/class-menu.php' );
require_once( INSIGHT_THEME_DIR . '/framework/class-statistics.php' );
