<?php
    setcookie('product8', isset($_COOKIE['product8']) ? ++$_COOKIE['product8'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Mountain Bike",time()+60*60*30*24,"/");

    setcookie('shaproduct8', isset($_COOKIE['shaproduct8']) ? ++$_COOKIE['shaproduct8'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 008 </h3>
                    <h3> Product Name: Mountain Bike  </h3>
                    <h3> Product Brand: B Twin </h3>
                    <h3> Price: $210 </h3>
										</section>

										<form method="post" action="add_to_cart.php">
										<div class="form-group">
											<input type="text" class="form-control" name="productName" value="Mountain Bike" style="width: 500px;">
										</div>
										<div class="form-group">
											<input type="text" class="form-control" name="productPrice" value="120" style="width: 500px;">
										</div>
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product8.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
...
$result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha8'");
...
<form method="POST" action="processReviewSha8.php" style="margin-left: 20px;">
<div class="form-group">
