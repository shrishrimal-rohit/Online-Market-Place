    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
              ...
              <p class="wow fadeInUp" data-wow-delay="0.8s">Coming Soon..</p>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-12">
        ...
        <div class="media wow fadeInUp" data-wow-delay="0.9s">
          <div class="media-object pull-left">
          <a href= "vpizza.php">
            <img src="images/gallery-img2.jpg" class="img-responsive" alt="Food Menu"></a>
        ...
        <div class="media wow fadeInUp" data-wow-delay="1.2s">
          <div class="media-object pull-left">
          <a href= "vmushroom.php">
            <img src="images/gallery-img3.jpg" class="img-responsive" alt="Food Menu"></a>
            <span class="menu-price">$24</span>
          </div>
          <div class="media-body">
        ...
        <div class="media wow fadeInUp" data-wow-delay="1.3s">
          <div class="media-object pull-left">
          <a href= "vspagetti.php">
            <img src="images/gallery-img7.jpg" class="img-responsive" alt="Food Menu"></a>
            <span class="menu-price">$90</span>
          </div>
          <div class="media-body">
            <h3 class="media-heading">Spagetti</h3>
            <p>Spagetti</p>
          </div>
        </div>
          ...
          <div class="media-object pull-left">
          <a href= "vbread.php">
            <img src="images/gallery-img8.jpg" class="img-responsive" alt="Food Menu"></a>
            <span class="menu-price">$6</span>
          </div>
          <div class="media-body">
            <h3 class="media-heading">Breads</h3>
            <p>Breads</p>
          </div>
        </div>
      ...
      <div class="col-md-6 col-sm-12">
        <div class="media wow fadeInUp" data-wow-delay="1s">
          <div class="media-object pull-left">
          <a href= "vsea.php">
            <img src="images/gallery-img4.jpg" class="img-responsive" alt="Food Menu"></a>
        ...
        <div class="media wow fadeInUp" data-wow-delay="1.3s">
          <div class="media-object pull-left">
          <a href= "vbeef.php">
            <img src="images/gallery-img5.jpg" class="img-responsive" alt="Food Menu"></a>
        ...
        <div class="media wow fadeInUp" data-wow-delay="1.3s">
          <div class="media-object pull-left">
          <a href= "vcurry.php">
            <img src="images/gallery-img9.jpg" class="img-responsive" alt="Food Menu"></a>
            <span class="menu-price">$74</span>
          </div>
          <div class="media-body">
            <h3 class="media-heading">Curry</h3>
            <p>Curry</p>
          </div>
        </div>
        ...
        <div class="media wow fadeInUp" data-wow-delay="1.3s">
          ...
          <a href= "vmasala.php">
            <img src="images/gallery-img5.jpg" class="img-responsive" alt="Food Menu"></a>
            <span class="menu-price">$54</span>
          </div>
          <div class="media-body">
            <h3 class="media-heading">Curry Masala</h3>
            <p>Curry Masala</p>
          </div>
        </div>
        ...
        <div class="media wow fadeInUp" data-wow-delay="1.6s">
          <div class="media-object pull-left">
          <a href= "vdinner.php">
            <img src="images/gallery-img6.jpg" class="img-responsive" alt="Food Menu"></a>
...
<section id="lastVis" class="parallax-section">
        
        </div>
        </section>


<!-- Last Visited Section End-->

<!-- Most Visited Section -->
<section id="mostVis" class="parallax-section">
        
        </div>
        </section>


<!-- Most Visited Section End-->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10">
        ...
        <div class="contact-form wow fadeInUp" data-wow-delay="0.7s">
<form method="post" action="/raction_page.php">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8 col-xs-8">
        <p>Copyright © 2016 Hotel Villa </p>
      </div>  
