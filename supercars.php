<?php
    setcookie('supercar', isset($_COOKIE['supercar']) ? ++$_COOKIE['supercar'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"Supercars",time()+60*60,"/");

    setcookie('shanproduct10', isset($_COOKIE['shanproduct10']) ? ++$_COOKIE['shanproduct10'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Supercars",time()+60*60*30*24,"/");
...
<div class="allcontain">
	<div class="feturedsection">
		<h1 class="text-center"><span class="bdots">&bullet;</span>S U P E R<span class="carstxt"> C A R S</span>&bullet;</h1>
	</div>
			...
			<div class="col-lg-12 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="image/car10.jpg" alt="porsche">
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
						<div class="featurecontant">
							<h1>THE NEW SUPERCAR</h1>
    ...
    <div class="form-group">
      <input type="text" class="form-control" name="productName" value="Super Cars" style="width: 500px;">
    </div>
    <div class="form-group">
...
<div id="center_button">
	...
	<?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='shan1'");
