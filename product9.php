<?php
    setcookie('product9', isset($_COOKIE['product9']) ? ++$_COOKIE['product9'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Regular Bike",time()+60*60*30*24,"/");

    setcookie('shaproduct9', isset($_COOKIE['shaproduct9']) ? ++$_COOKIE['shaproduct9'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 009 </h3>
                    <h3> Product Name: Regular Bike  </h3>
                    <h3> Product Brand: Firefox </h3>
                    <h3> Price: $270 </h3>
										</section>

										<form method="post" action="add_to_cart.php">
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productName" value="Regular Bike" style="width: 500px;">
                                        </div>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productPrice" value="270" style="width: 500px;">
                                        </div>
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product9.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha9'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewSha9.php" style="margin-left: 20px;">
                  <div class="form-group">
