<?php
    setcookie('product6', isset($_COOKIE['product6']) ? ++$_COOKIE['product6'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Soccer Ball Adidas",time()+60*60*30*24,"/");

    setcookie('shaproduct6', isset($_COOKIE['shaproduct6']) ? ++$_COOKIE['shaproduct6'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
        $x=$_COOKIE['number'];
        $x++;
        if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 006 </h3>
                    <h3> Product Name: Soccer Ball  </h3>
                    <h3> Product Brand: Adidas </h3>
                    <h3> Price: $170 </h3>
										</section>
										<form method="post" action="add_to_cart.php">
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productName" value="Soccer Ball" style="width: 500px;">
                                        </div>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="productPrice" value="170" style="width: 500px;">
                                        </div>
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product6.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha6'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewSha6.php" style="margin-left: 20px;">
                  <div class="form-group">
