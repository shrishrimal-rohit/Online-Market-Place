<?php
    setcookie('crossover', isset($_COOKIE['crossover']) ? ++$_COOKIE['crossover'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"Crossover Cars",time()+60*60,"/");

    setcookie('shanproduct6', isset($_COOKIE['shanproduct6']) ? ++$_COOKIE['shanproduct6'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"CrossOver Cars",time()+60*60*30*24,"/");
...
<div class="allcontain">
	<div class="feturedsection">
		<h1 class="text-center"><span class="bdots">&bullet;</span>C R O S S O V E R<span class="carstxt"> C A R S</span>&bullet;</h1>
	</div>
			...
			<div class="col-lg-12 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="image/car4.jpg" alt="porsche">
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
						<div class="featurecontant">
							<h1>THE NEW 718 CROSSOVER</h1>
    ...
    <div class="form-group">
      <input type="text" class="form-control" name="productName" value="CrossOver Cars" style="width: 500px;">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" name="productPrice" value="1200" style="width: 500px;">
    </div>
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/crossovers.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
	...
	<?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='shan4'");
    ...
    <hr/>
                <h3 style="text-decoration: underline;"> Leave a Review..</h3>
                  <form method="POST" action="processReviewShan4.php" style="margin-left: 20px;">
                      <div class="form-group">
