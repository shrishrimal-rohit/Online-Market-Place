...
<div id="dialog" class="dialog dialog-effect-in">
  <div class="dialog-front">
    <div class="dialog-content">
      <form id="login_form" class="dialog-form" action="php/rlogin.php" method="POST">
        <fieldset>
          ...
          <div class="text-center">
            <p>Do you wish to register<br> for <a href="rregister.php" class="link user-actions"><strong>a new account</strong></a>?</p>
          </div>
        </fieldset>
      </form>
    </div>
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
    ...
    <script  src="php/rlogin.php"></script>
