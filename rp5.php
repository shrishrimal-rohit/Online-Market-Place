<?php
    setcookie('p5', isset($_COOKIE['p5']) ? ++$_COOKIE['p5'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"HTML BASICS",time()+60*60*24*30,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/rp5.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
