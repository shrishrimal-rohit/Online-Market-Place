...
<nav class="w3-bar w3-black">
  ...
  <a href="rcontact.php" class="w3-button w3-bar-item">Contacts</a>
...
<body>
	...
	<head>
		...
		<p1>Buy books for geeks, #Geeksforbooks</p1>
...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
 ...
 <div id="boxshadow">
  <img src="./images/img1.jpg" alt="/images/img1.jpg" width="300" height="300">
</div>
</div>
<div class="w3-display-middle">
    <h1 class="w3-jumbo w3-animate-top">We are back with awsome collection of books. #booksforgeeks</h1>
