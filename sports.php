<?php
    ...
    setcookie('shanproduct1', isset($_COOKIE['shanproduct1']) ? ++$_COOKIE['shanproduct1'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Sports Car",time()+60*60*30*24,"/");
...
<div class="allcontain">
    ...
    <div class="form-group">
      <input type="text" class="form-control" name="productName" value="Sports Cars" style="width: 500px;">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" name="productPrice" value="2500" style="width: 500px;">
    </div>
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/sports.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
	...
	<?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='shan9'");
    ...
    <hr/>
                <h3 style="text-decoration: underline;"> Leave a Review..</h3>
                  <form method="POST" action="processReviewShan9.php" style="margin-left: 20px;">
                      <div class="form-group">
