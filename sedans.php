<?php
    setcookie('sedan', isset($_COOKIE['sedan']) ? ++$_COOKIE['sedan'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"Sedan Cars",time()+60*60,"/");

    setcookie('shanproduct5', isset($_COOKIE['shanproduct5']) ? ++$_COOKIE['shanproduct5'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Sedan Cars",time()+60*60*30*24,"/");
...
<div class="allcontain">
	<div class="feturedsection">
		<h1 class="text-center"><span class="bdots">&bullet;</span>S E D A N<span class="carstxt"> C A R S</span>&bullet;</h1>
	</div>
			...
			<div class="col-lg-12 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="image/car8.jpg" alt="porsche">
					</div>
...
<!-- paste from here -->
    ...
    <div class="form-group">
      <input type="text" class="form-control" name="productName" value="Sedan Cars" style="width: 500px;">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" name="productPrice" value="1000" style="width: 500px;">
    </div>
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/sedans.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
    ...
    <?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='shan8'");
    ...
    <hr/>
                <h3 style="text-decoration: underline;"> Leave a Review..</h3>
                  <form method="POST" action="processReviewShan8.php" style="margin-left: 20px;">
                      <div class="form-group">
