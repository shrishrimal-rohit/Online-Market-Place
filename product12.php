<?php
    setcookie('product12', isset($_COOKIE['product12']) ? ++$_COOKIE['product12'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Football",time()+60*60*30*24,"/");

    setcookie('shaproduct12', isset($_COOKIE['shaproduct12']) ? ++$_COOKIE['shaproduct12'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
		...
		<div id="page-wrapper">
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Product id: 012 </h3>
                    <h3> Product Name: Football </h3>
                    <h3> Product Brand: Wilson </h3>
                    <h3> Price: $190 </h3>
