<?php
    setcookie('pizza', isset($_COOKIE['pizza']) ? ++$_COOKIE['pizza'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"pizza",time()+60*60,"/");

    setcookie('vinproduct3', isset($_COOKIE['vinproduct3']) ? ++$_COOKIE['vinproduct3'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"pizza",time()+60*60*30*24,"/");
...
<div id="center_button">
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/vpizza.php'">Share With Google+</button>
</div>

<figure>
  <img src="images/gallery-img2.jpg" alt="Food Menu" width="400
  " height="400">

</figure>
<p><strong>Description:</strong>Pizza</p>

<!-- paste this in other pages -->

<form method="post" action="add_to_cart.php">
<div class="form-group">
  <input type="text" class="form-control" name="productName" value="pizza" style="width: 500px;">
</div>
<div class="form-group">
...
<?php
                ...
                $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='vin10'");
...
<hr/>
            <h3 style="text-decoration: underline;"> Leave a Review..</h3>
              <form method="POST" action="processReviewvin10.php" style="margin-left: 20px;">
                  <div class="form-group">
