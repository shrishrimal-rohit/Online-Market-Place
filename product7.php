<?php
    setcookie('product7', isset($_COOKIE['product7']) ? ++$_COOKIE['product7'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Soccer Ball Nike",time()+60*60*30*24,"/");

    setcookie('shaproduct7', isset($_COOKIE['shaproduct7']) ? ++$_COOKIE['shaproduct7'] : 1,time()+60*60*24*30,"/");
    if(isset($_COOKIE['number'])){
    	$x=$_COOKIE['number'];
    	$x++;
    	if($x>5) $x=1;
			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <h3> Price: $140 </h3>
										...
										<div class="form-group">
											<input type="text" class="form-control" name="productPrice" value="140" style="width: 500px;">
										</div>
...
<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false" class="fa fa-twitter" >Tweet</a>
    ...
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/product7.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
</div>
</div>
</div>
</div>
...
$result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='sha7'");
...
<form method="POST" action="processReviewSha7.php" style="margin-left: 20px;">
<div class="form-group">
