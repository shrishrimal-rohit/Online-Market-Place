    <?php
    setcookie('p10', isset($_COOKIE['p10']) ? ++$_COOKIE['p10'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Machine learning",time()+60*60*24*30,"/");
