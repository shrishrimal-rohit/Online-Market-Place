<?php
    setcookie('convertible', isset($_COOKIE['convertible']) ? ++$_COOKIE['convertible'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"Convertible Cars",time()+60*60,"/");

    setcookie('shanproduct8', isset($_COOKIE['shanproduct8']) ? ++$_COOKIE['shanproduct8'] : 1,time()+60*60*24*30,"/");
    ...
    setcookie($x,"Convertible Cars",time()+60*60*30*24,"/");
	...
	<nav class="topnavbar navbar-default topnav">
		...
		<div class="collapse navbar-collapse" id="upmenu">
			<ul class="nav navbar-nav" id="navbarontop">
				<li class="active"><a href="indexs.html">HOME</a> </li>
				<li>
...
<div class="allcontain">
	<div class="feturedsection">
		<h1 class="text-center"><span class="bdots">&bullet;</span>C O N V E R T I B L E<span class="carstxt"> C A R S</span>&bullet;</h1>
	</div>
			...
			<div class="col-lg-12 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="image/car3.jpg" alt="porsche">
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
						<div class="featurecontant">
							<h1>THE NEW 718 CONVERTIBLE</h1>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="productName" value="Covertible Cars" style="width: 500px;">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" name="productPrice" value="1250" style="width: 500px;">
    </div>
    ...
    <button onclick="location.href='https://plus.google.com/share?url=http://guptashantanu.com/convertibles.php'"><img src="images1/glogin.png" alt="" width="300" height="100"/></button> 
	...
	<?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM ProdReviews WHERE P_Id='shan3'");
    ...
    <hr/>
                <h3 style="text-decoration: underline;"> Leave a Review..</h3>
                  <form method="POST" action="processReviewShan3.php" style="margin-left: 20px;">
                      <div class="form-group">
